  ...
  shell.innerHTML = `
    ...
    <header class="site-header portal-site-header" id="unifiedSiteHeader">
      <div class="container header-main portal-brand-row">
        ...
        <a href="index.html" class="brand portal-header-brand" aria-label="Akçaabat Haber Ana Sayfa"><img class="portal-brand-logo" src="assets/akcaabat-haber-logo.png?v=4" alt="Akçaabat Haber — Karadeniz'in Güçlü Sesi" width="360" height="120"></a>
